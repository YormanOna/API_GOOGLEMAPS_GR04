    ...
    <body>
        ...
        <div class="main">
            <div class="grid-container">
                ...
                <!-- Sucursales -->
                <div class="operation-card sucursales-btn" onclick="window.location.href='<%= request.getContextPath()%>/sucursales'">
                    <div class="card-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" width="70" height="70">

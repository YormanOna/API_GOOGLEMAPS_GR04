...
insert into sucursal values( '001', 'Sipan', 'Quito', 'Av. Balta 1456', 2, -0.1806532, -78.4678382, TRUE );
insert into sucursal values( '002', 'Chan Chan', 'Guayaquil', 'Jr. Independencia 456', 3, -2.1709979, -79.9223592, TRUE );
insert into sucursal values( '003', 'Los Olivos', 'Cuenca', 'Av. Central 1234', 0, -2.9001285, -79.0058965, TRUE );
insert into sucursal values( '004', 'Pardo', 'Quito', 'Av. Pardo 345 - Miraflores', 0, -0.2201641, -78.5123274, TRUE );
insert into sucursal values( '005', 'Misti', 'Guayaquil', 'Bolivar 546', 0, -2.1894128, -79.8886891, TRUE );
insert into sucursal values( '006', 'Machupicchu', 'Cuenca', 'Calle El Sol 534', 0, -2.8973116, -79.0045757, TRUE );
insert into sucursal values( '007', 'Grau', 'Quito', 'Av. Grau 1528', 0, -0.2298500, -78.5249481, TRUE );
